...
const WhyMeSection = () => {
  return (
    <div className="why-me">
      <h2>Why Me</h2>
      <p>As a recent college graduate, I know that what I'm lacking is career experience.<br></br> However, I
         have used my time at university to develop many of the required <br></br>skills for this job. 
         For example, after interning in four different organizations <br></br>and managing a full course 
